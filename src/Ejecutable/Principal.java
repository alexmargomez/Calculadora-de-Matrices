...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		textField.setBounds(42, 30, 22, 20);
		contentPane.add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setBounds(74, 30, 22, 20);
		contentPane.add(textField_1);
		textField_1.setColumns(10);
		
		textField_2 = new JTextField();
		textField_2.setBounds(106, 30, 22, 20);
		contentPane.add(textField_2);
		textField_2.setColumns(10);
		
		textField_3 = new JTextField();
		textField_3.setBounds(42, 61, 22, 20);
		contentPane.add(textField_3);
		textField_3.setColumns(10);
		
		textField_4 = new JTextField();
		textField_4.setBounds(74, 61, 22, 20);
		contentPane.add(textField_4);
		textField_4.setColumns(10);
		
		textField_5 = new JTextField();
		textField_5.setBounds(106, 61, 22, 20);
		contentPane.add(textField_5);
		textField_5.setColumns(10);
		
		textField_6 = new JTextField();
		textField_6.setBounds(42, 92, 22, 20);
		contentPane.add(textField_6);
		textField_6.setColumns(10);
		
		textField_7 = new JTextField();
		textField_7.setBounds(74, 92, 22, 20);
		contentPane.add(textField_7);
		textField_7.setColumns(10);
		
		textField_8 = new JTextField();
		textField_8.setBounds(106, 92, 22, 20);
		...
		textField_9.setBounds(235, 30, 22, 20);
		contentPane.add(textField_9);
		textField_9.setColumns(10);
		
		textField_10 = new JTextField();
		textField_10.setBounds(267, 30, 22, 20);
		contentPane.add(textField_10);
		textField_10.setColumns(10);
		
		textField_11 = new JTextField();
		textField_11.setBounds(299, 30, 22, 20);
		contentPane.add(textField_11);
		textField_11.setColumns(10);
		
		JLabel lblMatrizB = new JLabel("Matriz B");
		lblMatrizB.setBounds(255, 11, 46, 14);
		contentPane.add(lblMatrizB);
		
		textField_12 = new JTextField();
		textField_12.setBounds(235, 61, 22, 20);
		contentPane.add(textField_12);
		textField_12.setColumns(10);
		
		textField_13 = new JTextField();
		textField_13.setBounds(235, 92, 22, 20);
		contentPane.add(textField_13);
		textField_13.setColumns(10);
		
		textField_14 = new JTextField();
		textField_14.setBounds(267, 61, 22, 20);
		contentPane.add(textField_14);
		textField_14.setColumns(10);
		
		textField_15 = new JTextField();
		textField_15.setBounds(299, 61, 22, 20);
		contentPane.add(textField_15);
		textField_15.setColumns(10);
		
		textField_16 = new JTextField();
		textField_16.setBounds(267, 92, 22, 20);
		contentPane.add(textField_16);
		textField_16.setColumns(10);
		
		textField_17 = new JTextField();
		textField_17.setBounds(299, 92, 22, 20);
		contentPane.add(textField_17);
		textField_17.setColumns(10);
		
		
		button = new JButton("Sumar");
		button.setBounds(137, 133, 89, 23);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Operaciones nuevos = new Operaciones(a, b);
				nuevos.setLocationRelativeTo(null);
				//setVisible(false);
